                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                  ...
                                  <a class="dropdown-item" href="{{ url('profile/'.Auth::user()->id) }}"><img src="/storage/avatars/{{ Auth::user()->avatar }}" width="25px" height="25px" style="border-radius: 50%;"> {{ Auth::user()->name }} </a>
